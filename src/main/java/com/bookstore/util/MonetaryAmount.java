...
public class MonetaryAmount implements Serializable {
	 ...
	 * 
	 * @param value
	 *            the value of the amount; for example, in $USD "10.00" would be
	 *            ten dollars, ".29" would be 29 cents
	 */
	 ...
	 * 
	 * @param value
	 *            the monetary amount as a double
	 */
	...
	/**
	 * Convert the string representation of a monetary amount (e.g. $5 or 5) to
	 * a MonetaryAmount object.
	 * 
	 * @param string
	 *            the monetary amount string
	 * @return the monetary amount object
	 */
	public static MonetaryAmount valueOf(String string) {
		if (string == null || string.length() == 0) {
			throw new IllegalArgumentException(
					"The monetary amount value is required");
		}
