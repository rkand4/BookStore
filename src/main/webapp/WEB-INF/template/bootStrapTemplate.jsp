	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><h2>Book Shop Management</h2> </a>
			...
			<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li><a href="${pageContext.request.contextPath}/listCustomers">Customers
								</a></li>
						<li><a href="${pageContext.request.contextPath}/listBooks">Books</a></li>
						<li><a href="${pageContext.request.contextPath}/listBooks">Sales</a></li>
						<li><a href="${pageContext.request.contextPath}/listBooks">Inventory</a></li>
